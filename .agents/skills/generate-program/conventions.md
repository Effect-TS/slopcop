...
> **Note:** This file is a snapshot of the conventions practiced in the live Foldkit codebase. In OpenCode, resolve repository paths through `@foldkit` first; otherwise use `repos/foldkit/` or the Foldkit project root. If anything here contradicts the live examples or source, the live code is canonical.
