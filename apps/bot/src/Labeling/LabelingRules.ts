...
import { GitHubClient, GitHubClientError } from "../GitHub/GitHubClient.ts"
import { RepositoryNotConfigured } from "../GitHub/Errors.ts"
import type { GitHubRepositoriesRepoError } from "../GitHub/repositories/GitHubRepositoriesRepo.ts"
import { GitHubRepositoriesRepo } from "../GitHub/repositories/GitHubRepositoriesRepo.ts"
...
>()("@slopcop/bot/Labeling/LabelingRules", {
  make: Effect.gen(function* () {
    ...
    const getEnabledRepository = Effect.fn(
      "LabelingRules.getEnabledRepository",
    ...
    const list = Effect.fn("LabelingRules.list")(function* (
      ...
      const repository = yield* getEnabledRepository(name)
    ...
    const create = Effect.fn("LabelingRules.create")(function* (
      ...
      const latest = yield* getEnabledRepository(name)
